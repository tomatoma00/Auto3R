...
V50Seq4Inplace = partial(VNSeqMInplace, N=20, M=1, num_init_views=4, interval_epochs=100)
V60Seq4Inplace = partial(VNSeqMInplace, N=20, M=1, num_init_views=5, interval_epochs=250)
...
schema_dict: Dict[str, BaseSchema] = {'all': All, "debug": V20Seq1Debug,
                                      ...
                                      "v20seq4_inplace": V20Seq4Inplace, "v50seq4_inplace": V50Seq4Inplace,
                                      "v60seq4_inplace": V60Seq4Inplace
                                      }
